...
class Maths {
  ...
  static add(a: any, b: any, c = 0): number {
    return a + b + c;
  }

  static multiply(a: number, b: number): number;
  static multiply(a: number, b: number, c: number): number;

  static multiply(a: number, b: number, c = 0): number {
    if (c === 0) {
      return a * b;
    }
    return a * b * c;
...
console.log("Sum of a, b and c = ", Maths.add(2, 3, 4));
console.log("Sum of a and b = ", Maths.add(2, 3));
